...
def main():
   ...
   Example use:
       python drafter.py --procedure=col --pred_csv=results/col/longform/long-10-2025_colonoscopies.csv --polyp_csv=results/col/longform/long-10-2025_polyps.csv --output_dir=drafters/results/col/longform --samples_to_process all 
       ...
       python drafter.py --procedure=ercp --pred_csv=results/ercp/longform/long-10-2025.csv --output_dir=drafters/results/ercp/longform --samples_to_process bdstricture01 bdstone01
  
       python drafter.py --procedure=egd --pred_csv=results/egd/longform/long-10-2025.csv --output_dir=drafters/results/egd/longform --samples_to_process egd01 egd02 egd03
   '''
