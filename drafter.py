...
def main():
    ...
    parser.add_argument('--patients_data', default="ehr/patients.csv", help="Path to patient info data from RedCap")
    parser.add_argument('--procedures_data', default="ehr/procedures.csv", help="Path to patient info data from RedCap")
